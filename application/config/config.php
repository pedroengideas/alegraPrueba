...
$config['base_url'] = ((isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] == "on") ? "https" : "http");
$config['base_url'] .= "://".$_SERVER['HTTP_HOST'].'/alegraPrueba/';
...
$config['lang_uri_abbr'] = array("es" => "espanish", "en" => "english", "jp" => "japones");

$config['lang_abbr_write'] = array("espanish" => "espanish", "english" => "english", "japanes" => "japones");
